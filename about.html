...
<html lang="zxx">
    ...
    <body>
        ...
        <section class="page-banner overlay pt-170 pb-170 bg_cover" style="background-image: url(assets/images/bg/about_cover.png);">
            <div class="container">
                ...
                <div class="row align-items-xl-center">
                    <div class="col-lg-6 order-2 order-lg-1">
                        ...
                        <div class="we-image-box text-center text-lg-left wow fadeInDown">
                            <img src="assets/images/gallery/about/intro.png" class="radius-top-left-right-288" alt="Image">
                        </div>
                    </div>
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-6">
                                    <div class="we-image mb-30 wow fadeInLeft">
                                        <img src="assets/images/gallery/about/1.png" alt="we Image">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="we-image mb-30 wow fadeInRight">
                                        <img src="assets/images/gallery/about/2.png" alt="we Image">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="we-image mb-30 pr-lg-30 text-md-end wow fadeInDown">
                                        <img src="assets/images/gallery/about/3.png" alt="we Image">
                                    </div>
                                </div>
                            </div>
                        </div>
