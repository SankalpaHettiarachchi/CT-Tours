...
<html lang="zxx">
    ...
    <body>
        ...
        <section class="page-banner overlay pt-170 pb-170 bg_cover" style="background-image: url(assets/images/bg/gallary_cover.png);">
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="single-gallery-item mb-30 wow fadeInUp">
                            <div class="gallery-img">
                                <img src="assets/images/gallery/gallary/1.png" alt="Gallery Image">
                                <div class="hover-overlay">
                                    <a href="assets/images/gallery/gallary/1.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="single-gallery-item mb-30 wow fadeInUp">
                            <div class="gallery-img">
                                <img src="assets/images/gallery/gallary/2.png" alt="Gallery Image">
                                <div class="hover-overlay">
                                    <a href="assets/images/gallery/gallary/2.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="single-gallery-item mb-30 wow fadeInUp">
                            <div class="gallery-img">
                                <img src="assets/images/gallery/gallary/3.png" alt="Gallery Image">
                                <div class="hover-overlay">
                                    <a href="assets/images/gallery/gallary/3.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="single-gallery-item mb-30 wow fadeInUp">
                            <div class="gallery-img">
                                <img src="assets/images/gallery/gallary/4.png" alt="Gallery Image">
                                <div class="hover-overlay">
                                    <a href="assets/images/gallery/gallary/4.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="single-gallery-item mb-30 wow fadeInUp">
                            <div class="gallery-img">
                                <img src="assets/images/gallery/gallary/5.png" alt="Gallery Image">
                                <div class="hover-overlay">
                                    <a href="assets/images/gallery/gallary/5.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
