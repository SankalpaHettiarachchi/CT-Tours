...
<html lang="zxx">
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="primary-menu">
                        ...
                        <div class="site-branding">
                            <a href="index.html" class="brand-logo"><img src="assets/images/logo/CT_Logo.png" alt="Site Logo"></a>
                        </div>
                        <!--====== Nav Menu ======-->
                        <div class="nav-menu">
                            <!--====== Site Branding ======-->
                ...
                <div class="slider-active-4-item wow fadeInUp">
                    ...
                    <div class="single-features-item mb-40">
                        <div class="img-holder">
                            <img src="assets/images/features/1.png" alt="Features Image">
                            <div class="content">
                                <div class="text">
                    ...
                    <div class="single-features-item mb-40">
                        <div class="img-holder">
                            <img src="assets/images/features/2.png" alt="Features Image">
                            <div class="content">
                                <div class="text">
                    ...
                    <div class="single-features-item mb-40">
                        <div class="img-holder">
                            <img src="assets/images/features/3.png" alt="Features Image">
                            <div class="content">
                                <div class="text">
                    ...
                    <div class="single-features-item mb-40">
                        <div class="img-holder">
                            <img src="assets/images/features/4.png" alt="Features Image">
                            <div class="content">
                                <div class="text">
                ...
                <div class="row align-items-xl-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="booking-image-box mb-50 ml-lg-45 wow fadeInRight">
                            <img src="assets/images/contact/2.png" class="radius-60" alt="Contact Image">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="activity-image-box">
                                                <img src="assets/images/gallery/1.png" class="radius-12" alt="Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="tab2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <!--=== Activity Image Box ===-->
                                            <div class="activity-image-box">
                                                <img src="assets/images/gallery/3.png" class="radius-12" alt="Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="tab3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                            <!--=== Activity Image Box ===-->
                                            <div class="activity-image-box">
                                                <img src="assets/images/gallery/2.png" class="radius-12" alt="Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="tab4">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                            <!--=== Activity Image Box ===-->
                                            <div class="activity-image-box">
                                                <img src="assets/images/gallery/4.png" class="radius-12" alt="Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="slider-active-3-item wow fadeInUp">
                    ...
                    <div class="single-service-item mb-40">
                        ...
                        <div class="img-holder">
                            <img src="assets/images/service/3.png" alt="Service Image">
                        </div>
                    </div>
                    <!--=== Single Service Item ===-->
                    <div class="single-service-item mb-40">
                        ...
                        <div class="img-holder">
                            <img src="assets/images/service/4.png" alt="Service Image">
                        </div>
                    </div>
                    <!--=== Single Service Item ===-->
                    <div class="single-service-item mb-40">
                        ...
                        <div class="img-holder">
                            <img src="assets/images/service/2.png" alt="Service Image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--====== Start CTA Section ======-->
        <section class="cta-bg overlay bg_cover pt-140 pb-150" style="background-image: url(assets/images/bg/1.png);">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <!--=== CTA Content Box ===-->
                ...
                <div class="row align-items-xl-center">
                    <div class="col-xl-5 col-lg-12 order-2 order-xl-1">
                        ...
                        <div class="testimonial-one_image-box mb-40 wow fadeInLeft">
                            <img src="assets/images/testimonial/3.png" alt="Testimonial Image">
                        </div>
                    </div>
                                ...
                                <div class="testimonial-inner-content">
                                    ...
                                    <div class="author-thumb-title">
                                        <div class="author-thumb">
                                            <img src="assets/images/testimonial/author.png" alt="Author Image">
                                        </div>
                ...
                <div class="slider-active-5-item wow fadeInUp">
                    ...
                    <div class="single-gallery-item">
                        <div class="gallery-img">
                            <img src="assets/images/gallery/footer/1.png" alt="Gallery Image">
                            <div class="hover-overlay">
                                <a href="assets/images/gallery/footer/1.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--=== Single Gallery Item ===-->
                    <div class="single-gallery-item">
                        <div class="gallery-img">
                            <img src="assets/images/gallery/footer/2.png" alt="Gallery Image">
                            <div class="hover-overlay">
                                <a href="assets/images/gallery/footer/2.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--=== Single Gallery Item ===-->
                    <div class="single-gallery-item">
                        <div class="gallery-img">
                            <img src="assets/images/gallery/footer/3.png" alt="Gallery Image">
                            <div class="hover-overlay">
                                <a href="assets/images/gallery/footer/3.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--=== Single Gallery Item ===-->
                    <div class="single-gallery-item">
                        <div class="gallery-img">
                            <img src="assets/images/gallery/footer/4.png" alt="Gallery Image">
                            <div class="hover-overlay">
                                <a href="assets/images/gallery/footer/4.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--=== Single Gallery Item ===-->
                    <div class="single-gallery-item">
                        <div class="gallery-img">
                            <img src="assets/images/gallery/footer/5.png" alt="Gallery Image">
                            <div class="hover-overlay">
                                <a href="assets/images/gallery/footer/5.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--=== Single Gallery Item ===-->
                    <div class="single-gallery-item">
                        <div class="gallery-img">
                            <img src="assets/images/gallery/footer/6.png" alt="Gallery Image">
                            <div class="hover-overlay">
                                <a href="assets/images/gallery/footer/6.png" class="icon-btn img-popup"><i class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
